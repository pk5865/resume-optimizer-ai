...
export default function App() {
  ...
  useEffect(() => {
    setApprovedAdditions(suggestedAdditions);
  }, [suggestedAdditions]);
  ...
  const uploadResume = async () => {
    ...
    try {
      ...
      setApprovedAdditions(res.data.detected_keywords || []);
    } catch (err) {
  ...
  const analyzeResume = async () => {
    ...
    try {
      ...
      setApprovedAdditions(res.data.suggested_additions || []);
    } catch (err) {
      ...
      <div className="shell">
        ...
        {suggestedAdditions.length > 0 && (
          <section className="panel">
            ...
            <p>Select only the items you want the resume to include.</p>
            <div className="chips">
